                        ...
                        foreach (KeyValuePair<string, Person> thisEntry in people.sortedList)
                        {
                            ...
                            if (thisPerson.GetType() == typeof(Student))
                            {
                                ...
                                foreach(string courseCode in student.courseCodes)
                                {
                                    ...
                                    Console.WriteLine($"\t{thisCourse.courseCode} - {thisCourse.description} " +
                                        $"{thisCourse.schedule.daysOfWeek} {thisCourse.schedule.startTime:hh:mmtt}" +
                                        $"-{thisCourse.schedule.endTime}");
                                }
                            }
