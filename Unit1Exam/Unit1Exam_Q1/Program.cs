...
namespace Unit1Exam_Q1
{
    static internal class Program
    {
        // CODE COPY-PASTED AND MODIFIED FROM MATHQUIZ.CS
        ...
        start:
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                // MODIFIED FOR DIVISION: if nOp == 2 then division
                // else multiplication
                if (nOp == 0)
                {
                    nAnswer = val1 + val2;
                ...
                {
                    dAnswer = (double)val1 / (double)val2;
                ...
                do
                {
                    ...
                    // if operation is division, ask for a double
                    if (nOp == 2)
                    {
                        try
                        {
                    ...
                    // if operation is other, ask for int
                    else
                    {
                        try
                        {
                ...
                // MODIFIED FOR DIVISION: if operator is division check doubles
                else if (dResponse == dAnswer)
                {
                    Console.BackgroundColor = ConsoleColor.Blue;
                    Console.ForegroundColor = ConsoleColor.Magenta;
                    Console.WriteLine("Well done, {0}!!!", myName);
                ...
                // MODIFIED FOR DIVISION: if operator is division check doubles
                else if (nOp == 2 && dResponse != dAnswer)
                {
                    Console.BackgroundColor = ConsoleColor.Black;
