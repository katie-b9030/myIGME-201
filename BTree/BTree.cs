...
namespace BTree
{
    public partial class BTreeForm : Form
    {
        ...
        private void Exercise1__Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 30; ++i)
            {
                node = new BTree(random.Next(52), root);
        ...
        private void Exercise3__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            node = new BTree("ROOT", root);
            root = node;
            node = new BTree("WELCOME", root);
            node = new BTree("HELLO", root);
            node = new BTree("JOINT", root);
            node = new BTree("BACKWARD", root);
            node = new BTree("LAST", root);
            node = new BTree("FORWARD", root);
            node = new BTree("QUAKE", root);
            node = new BTree("SEDENTARY", root);
            node = new BTree("ESCAPE", root);
            node = new BTree("THERE", root);
            node = new BTree("KINDLE", root);
            node = new BTree("METOPE", root);
            node = new BTree("ATLANTIS", root);
            node = new BTree("CREATIVE", root);
        ...
        private void Exercise4__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            node = new BTree("MOROCCO", null, false);
            root = node;
            node = new BTree("FREEDOM", root, false);
            node = new BTree("CORDUROY", root, false);
            node = new BTree("HONOR", root, false);
            node = new BTree("TRAVERSAL", root, false);
            node = new BTree("PINEAPPLE", root, false);
            node = new BTree("WHALE", root, false);
        ...
        private void Exercise6__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            person = new Person("Katie", 19);
            node = new BTree(person, root);
            root = node;
            person = new Person("Mady", 17);
            node = new BTree(person, root);
            person = new Person("Melissa", 52);
            node = new BTree(person, root);
            person = new Person("David", 57);
            node = new BTree(person, root);
            person = new Person("Julie", 76);
            node = new BTree(person, root);
            person = new Person("Nicole", 50);
            node = new BTree(person, root);
            person = new Person("Dave", 48);
            node = new BTree(person, root);
            person = new Person("Morgan", 16);
            node = new BTree(person, root);
            person = new Person("Trevor", 14);
            node = new BTree(person, root);
            person = new Person("Carrie", 53);
            node = new BTree(person, root);
            person = new Person("Tim", 54);
            node = new BTree(person, root);
            person = new Person("Gavin", 19);
            node = new BTree(person, root);
            person = new Person("Mason", 16);
            node = new BTree(person, root);
            person = new Person("Dan", 54);
            node = new BTree(person, root);
            person = new Person("Chris", 59);
            node = new BTree(person, root);
            person = new Person("Lisa", 59);
            node = new BTree(person, root);
            person = new Person("Eric", 34);
            node = new BTree(person, root);
            person = new Person("Adam", 32);
            node = new BTree(person, root);
            person = new Person("Gabby", 31);
            node = new BTree(person, root);
            person = new Person("Leo", 2);
            node = new BTree(person, root);
